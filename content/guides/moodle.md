...
**Note**: This repository is already configured to run `/admin/cli/cron.php` every minute as a [CRON job](https:// developers-staging.cleverapps.io/doc/administrate/cron/).
