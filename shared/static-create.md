...
You can create an application in our [Console](https://console.clever-cloud.com) or through [Clever Tools](/doc/manage/cli). Install them with `npm` or [any supported package manager](/doc/manage/cli/install/):
