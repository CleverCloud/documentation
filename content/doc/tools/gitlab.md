...
The self-hosted GitLab service on Clever Cloud with [Heptapod](/doc/deploy/services/heptapod) already hosts the components, you don't need to do any set up like you would in a self-hosted instance:

1. Create a `.gitlab-ci.yml` at the root of your repository with [the component to use](/doc/tools/gitlab/#use-the-components-catalog)
2. Add [the variables](/doc/tools/gitlab/#mandatory-configuration) to your repository settings
3. Run the pipeline
...
{{< cards >}}
  ...
  {{< card link="/developers/doc/manage/cli" title="Clever Tools CLI" subtitle="Deploy and manage your applications and dependencies from your terminal." icon="command-line" >}}
{{< /cards >}}
