...
Each Clever Cloud account organisation [comes with a pre-configured Grafana service](/doc/develop/observability/metrics/#publish-your-own-metrics). With recent Keycloak enhancements on metrics and observability, we've worked on a Grafana dashboard ready to import:
