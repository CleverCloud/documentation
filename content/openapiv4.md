...
- `/v4/orchestration/organisations/{ownerId}/applications/{applicationId}/deployments/{deploymentId}/instances`
- Type: `GET`
...
Answers with logs in a SSE (Server-Sent Events) stream. You can use the optional parameters to filter it:
