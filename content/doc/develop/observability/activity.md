...
- monitoring timeline
aliases:
- /doc/administrate/activity
- /doc/observability/activity
---
...
- [Restart or rebuild](/doc/develop/common-configuration/lifecycle/#start-restart-and-stop) from the Console or [the CLI](/doc/manage/cli/)
