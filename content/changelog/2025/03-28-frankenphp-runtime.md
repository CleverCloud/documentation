...
Just create a FrankenPHP application [from API](/api), [Console](https://console.clever-cloud.com) or with [Clever Tools](/doc/manage/cli) and deploy it:
