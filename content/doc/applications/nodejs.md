...
If you need to run a custom command (or just pass options to the program), you can specify it through:

* The `CC_RUN_COMMAND` [environment variable](/developers/doc/reference/reference-environment-variables/)
* The `scripts.start` field in your `package.json` file
