...
As our network evolves, we've updated [IP list for Paris (PAR) zone](/doc/develop/common-configuration/domain-names/#europeparis-par). If you use A records for DNS configuration, update them. 4 new IP addresses should be added (`91.208.207.220` to `91.208.207.223`). **We strongly recommend using CNAME records instead.**
