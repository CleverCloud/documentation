...
Since building with the latest version of Node.js might fail, you should specify in the `package.json` file of the application the version needed for your Meteor application ; as shown in [Deploying Node.js apps](/doc/deploy/applications/nodejs/#mandatory-needs) documentation.
...
Meteor.js uses a lot of memory during the build. You most likely will need to activate the [dedicated build feature](/doc/develop/common-configuration/lifecycle/#edit-application-configuration) and set your vertical scaling size at least to **M**.
