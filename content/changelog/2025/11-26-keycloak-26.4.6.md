...
You can update through add-on’s dashboard in the [Clever Cloud Console](https://console.clever-cloud.com). You can also set `CC_KEYCLOAK_VERSION` of the underlying Java application to `26.4.6` and rebuild it, or use [Clever Tools](/doc/manage/cli/operators/):
