...
Follow the [File System buckets documentation page](/doc/deploy/storage/fs-bucket) to set up an FS Bucket for your application.
{{% /details %}}
...
2. Create an asynchronous worker system: move long-running tasks to a background [worker](/doc/develop/common-configuration/workers/)
...
Use your embedded [Grafana](/doc/develop/observability/metrics/) to monitor resource usage when implementing any of these solutions.
