...
|---|---|
| `almighty` | Grants all permissions below at once |
...
You can retrieve this list programmatically with `GET https://api.clever-cloud.com/v2/oauth/rights` (note: `almighty` is not included in this response as it is a meta-permission that encompasses all others).
