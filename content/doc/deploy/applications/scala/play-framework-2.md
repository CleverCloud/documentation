...
- /doc/applications/scala/play-framework-2
...
- Starting from **Play 2.4**, your application needs **Java 8** to run. Please read [select java version](/doc/deploy/applications/java/java-war/#available-java-versions "Select Java version") for more information.

Play! 2 applications use sbt. Please have a look at [deploy Scala apps](/doc/deploy/applications/scala) for a complete documentation on sbt deployment options.
