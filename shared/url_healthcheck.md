...
By default, when no [environment variable](/doc/develop/common-configuration/environment-variables/reference) (for ex: `APP_HOME`) is defined, the monitoring checks your repository root path `/`.
