...
PostgreSQL databases managed by Clever Cloud come with [lots of extensions enabled by default](/doc/deploy/databases/postgresql/#default-extensions). There are also [some you can ask for](/doc/deploy/databases/postgresql/#on-demand-extensions), and we'll set them up, like `pg_cron`, `pgtap` or `timescaledb`.
