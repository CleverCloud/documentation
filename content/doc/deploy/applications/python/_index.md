...
> [!NOTE]
> Backend selection only applies to the legacy deployment mode (without `uv.lock`). [Native uv deployments](/doc/deploy/applications/python/uv/) manage their own HTTP server.
