...
New images include security patches, Linux kernel 6.7.1, OpenSSL 3.2.1 and Node.js 20.11.0 by default. For the latter, you can set it via the `CC_NODE_VERSION` [environment variable](/doc/develop/common-configuration/environment-variables/reference/#common-to-all-applications). Other changes are as follows:

- **.NET:**
  - Version 8.0 support
  - `CC_DOTNET_VERSION` [environment variable](/doc/develop/common-configuration/environment-variables/reference/#net) can be `6.0` or `8.0`
- **Java - Elastic / APM:**
