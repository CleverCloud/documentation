...
You can find out more about rules and format in [this page](/doc/develop/common-configuration/environment-variables#environment-variables-rules-and-formats).
