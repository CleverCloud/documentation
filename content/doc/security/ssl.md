...
1. Add your domain to the application:
   - Use the Console or
   - Use clever-tools
2. [Configure your DNS records](/doc/develop/common-configuration/domain-names) to point to Clever Cloud's load balancers
...
 You can enable [Force HTTPS](/doc/develop/common-configuration/lifecycle#edit-application-configuration) in the information tab of your Clever Cloud application instead.
