...
1. Make sure you have clever-tools installed locally. Report to the [getting started](/doc/manage/cli/) guide if needed.
...
Refer to the [documentation](/doc/manage/cli/applications/) for more details on application creation with Clever Tools
