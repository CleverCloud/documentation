...
{{< cards >}}
  ...
  {{< card link="/developers/doc/ci-cd/custom-scripts" title="Write your own CI/CD" subtitle="Write scripts to deploy to Clever Cloud and automate tasks" icon="command-line" >}}
{{< /cards >}}
