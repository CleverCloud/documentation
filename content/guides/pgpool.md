...
The available Pgpool-II variables and their descriptions are available on our [environment variables reference page](/developers/doc/reference/reference-environment-variables/).
...
Connect via [ssh](/developers/doc/administrate/ssh-clever-tools/) to your application and use the [psql](https://docs.postgresql.fr/10/app-psql.html) command.
