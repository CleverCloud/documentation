...
The available Pgpool-II variables and their descriptions are available on our [environment variables reference page](/doc/develop/common-configuration/environment-variables/reference/).
...
Many other **load balancing** options are configurable with environment variables. You can refer to our [environment variables reference page](/doc/develop/common-configuration/environment-variables/reference/) and the [official Pgpool-II documentation](https://www.pgpool.net/docs/latest/en/html/runtime-config-load-balancing.html) for more information.
...
Connect via [ssh](/doc/develop/ssh-access/) to your application and use the [psql](https://docs.postgresql.fr/10/app-psql.html) command.
