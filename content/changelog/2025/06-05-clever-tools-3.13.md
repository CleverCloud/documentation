---
title: 'Clever Tools 3.13: emails, operators, SSH keys and better UX'
date: 2025-06-05
tags:
  - clever-tools
  - cli
...
- [Learn more about Operators commands in Clever Tools](/developers/doc/develop/operators/)
...
- [Learn more about emails and ssh-keys commands in Clever Tools](/developers/doc/develop/emails-and-ssh-keys/)

## Task configuration

You can also use `clever config` to set an application as a Task after its creation of get this option configuration:

```
clever config get task
clever config set task TASK
clever config set task REGULAR
clever config update --name "My new task name" --enable-task
```

- [Learn more about config command in Clever Tools](/developers/doc/develop/tasks/)
