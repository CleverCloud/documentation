...
The [0.10.0 release](https://github.com/CleverCloud/terraform-provider-clevercloud/releases/tag/v0.10.0) of the Clever Cloud Terraform provider is available. It fixes some bugs, introduces support for [Network Groups](/doc/network/network-groups/) and [Pulsar](/doc/deploy/pulsar/). You can set a version for a [PostgreSQL add-on](/doc/deploy/databases/postgresql/).
