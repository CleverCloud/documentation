...
You can update through add-on's dashboard in the [Clever Cloud Console](https://console.clever-cloud.com). You can also set `CC_OTOROSHI_VERSION` of the underlying Java application to `v17.8.0_1762533533` and rebuild it, or use [Clever Tools](/doc/manage/cli/operators/):
