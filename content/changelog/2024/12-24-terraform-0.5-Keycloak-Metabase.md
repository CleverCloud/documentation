...
You can now deploy [Keycloak](/doc/deploy/services/keycloak) and [Metabase](/doc/deploy/services/metabase) add-ons using our Terraform provider, compatible with OpenTofu.
