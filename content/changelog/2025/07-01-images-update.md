...
- Port auto-configuration for `frankenphp` and `static` when [Redirection.io is enabled](/doc/develop/common-configuration/environment-variables/reference/#use-redirectionio-as-a-proxy)
