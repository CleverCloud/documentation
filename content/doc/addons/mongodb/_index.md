...
- **A monitoring and alert system** that can be configured with Grafana ([an example with Slack alerts can be found](https://www.clever-cloud.com/blog/features/2021/12/03/slack-alerts-for-grafana/)).
