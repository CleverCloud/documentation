...
- /doc/add-ons/mysql
- /doc/addons/mysql
- /doc/applications/databases/mysql
- /doc/databases/mysql
...
Encryption at rest is available on MySQL. You can have more information on the [dedicated page](/doc/security/encryption-at-rest).
