...
We've upgraded the applications' Domains page in the Console. It's now more clear, complete and easy to use. We designed it to highlight some of our underrated features such as [path routing](/doc/develop/common-configuration/domain-names/#path-routing). You also now have:
