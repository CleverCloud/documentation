...
You can find [an hello world tutorial of a Ruby and Rack application]({{< ref "/guides/ruby-rack-app-tutorial" >}}) and find [the source code of the demo](https://github.com/CleverCloud/rack-example).
