...
{{< callout type="warning" >}}
  The `*.cleverapps.io` domains are provided for development and testing purposes. They point to specific reverse proxies and have the following drawbacks: the .io TLD isn't stable, and since we offer the domain, the likelihood of people abusing it can be very high. **It is therefore not possible to guarantee a high level of quality on cleverapps domains**.
{{< /callout >}}
