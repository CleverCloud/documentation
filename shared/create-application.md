...
1. Make sure you have clever-tools installed locally or follow our [CLI getting started](/doc/manage/cli/) guide.
...
Refer to [clever create](/doc/manage/cli/applications/) for more details on application creation with Clever Tools.
